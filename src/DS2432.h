...
//copy from DS2431 to DS2432 with a bypass for read auth

#ifndef ONEWIREHUB_DS2432_H
#define ONEWIREHUB_DS2432_H

#include "OneWireItem.h"

class DS2432 : public OneWireItem
{
private:
...
public:
    static constexpr uint8_t family_code{0x33};

    DS2432(uint8_t ID1, uint8_t ID2, uint8_t ID3, uint8_t ID4, uint8_t ID5, uint8_t ID6,
           uint8_t ID7);
    ...
    bool writeScratchpad(const uint8_t *source);
